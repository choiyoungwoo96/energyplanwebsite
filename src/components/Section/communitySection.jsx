...
export default function CommunitySection() {
  return (
    <section
      className="w-screen bg-cover bg-center px-4 scroll-mt-16"
      ...
      >
        <div className="w-full max-w-7xl mx-auto py-16">
          <div className="flex flex-col items-center justify-center text-center text-white">
            ...
            {/* 유튜브 썸네일 */}
            <div className="w-full max-w-7xl aspect-video mb-10 rounded-xl overflow-hidden shadow-lg border-4 border-white">
              <iframe
